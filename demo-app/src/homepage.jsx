...
const Homepage = (props) => {
    ...
    return (
        <>
                ...
                <div className="col m-2">
                    ...
                    <div className="row m-2">
                        <div className="col m-2">
                            ...
                            <div className="row m-1">
                                <Settings automaticMode={automaticMode} setAutomaticMode={setAutomaticMode}/>
                            </div>
                        </div>
            ...
            <li>From sensor dashboard, call api, get values of all sensor, send each value as a property to each unit</li>
        </>
    )
}
